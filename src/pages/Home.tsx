...
const Home: FC = () => {
  const genres =
    "マタニティフォト、ニューボーンフォト、お宮参り、バースデー、七五三、カップルフォト、家族撮影、シニアフォトなどなど、今だけの貴重な瞬間を未来に残すお手伝いをさせていただきます。";
  const coronaVirus =
    "安全・安心を最優先にスタッフの毎日の検温、月1回のPCR検査、撮影機器や小物類の消毒、マスクと消毒の徹底";
  const notes =
    "撮影中のお客様での写真撮影・動画撮影はご遠慮頂いております。お子様のご機嫌に合わせてご撮影させていただきますので撮影時間が長引く場合や、天候などの影響で後日の撮影になる可能性があります。撮り直しの場合にはその都度の出張費のみお支払い頂きます。";
  const howToPay =
    "※現在事務所立ち上げ準備中につき、2022年6月末までは現金のみのお支払いになります。";
